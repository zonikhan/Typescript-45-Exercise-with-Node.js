...
let guestlist =[ "sonu","ahsan","Usman","Hamza"];
...
// Making a varable for  storing  a middle index of our guest list array
 ...
 while(guestlist.length > 2) {
    ...
    console.log(`sorry,the ${removedGuest}I can inite you tod dinner`);
 }
// sending q inivitation to the last two guest on the list
 console.log("Invitations to the last 2 Guest");
guestlist.forEach(lasttwo => console.log(`Lucky ${lasttwo}, you are still inviteted to dinner`));
